...
sim_name = "Landau"
tail = "CheckDiag"
pathname = '/ptmp/sonnen/gempic_gpu_runs/'+sim_name + tail
...
ax.semilogy(time,0.5*(0.05*np.pi*0.4246*np.exp(-0.0661*time)*np.cos(1.2850*time-0.335))**2)
# the analytical solution of the linear Landau damping problem for k=0.5
#ax.semilogy(time,(0.5*np.pi*0.3677*np.exp(-0.1533*time)*np.cos(1.4156*time-0.53))**2)
ax.set_xlabel('time')
ax.set_ylabel('$Ex^2$')
ax.set_title('$Ex^2$ vs. Time')
ax.legend([sim_name],loc='upper right')
...
#plt.semilogy((2.e-5*np.exp(2*0.0866*time[i1:i2])))
plt.semilogy(0.5*(0.05*np.pi*0.4246*np.exp(-0.0661*time[i1:i2])*np.cos(1.2850*time[i1:i2]-0.335))**2)
