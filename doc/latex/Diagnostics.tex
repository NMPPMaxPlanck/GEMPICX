...
\begin{itemize}
    ...
    \item \texttt{ParticleVariance}: The root mean square variance characteristics of all particle species, calculated separately, which comprises the variance of the particle weights, the variance of velocity and velocity squared in all three dimensions and the first mode of the $x$-dimension density in Fourier space.
