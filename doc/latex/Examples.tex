...
\subsection{Vlasov-Maxwell non relativistic}
...
We apply a structure-preserving mimetic finite difference PIC discretization and obtain a discrete noncanonical Hamiltonian system. We offer two numerical schemes to solve this system, namely \verb|HamiltonianSplittingExact| and \verb|HamiltonianSplittingNested|, which are described in detail in \ref{sec:splitting_vlasovmaxwell}.
...
with \verb|HamiltonianSplittingExact| and \verb|HamiltonianSplittingNested| respectively.

\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{../_static/graphics/Examples/VlasovMaxwell_WeibelExact.png}
    \caption{Energyplots for the Weibel instability using the \verb|HamiltonianSplittingExact| splitting method.}
    \label{fig:vmaxweibelfourier}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{../_static/graphics/Examples/VlasovMaxwell_WeibelNested.png}
    \caption{Energyplots for the Weibel instability using the \verb|HamiltonianSplittingNested| splitting method.}
