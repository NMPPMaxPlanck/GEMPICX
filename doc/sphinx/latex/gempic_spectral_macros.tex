%% Macros for Gempic/Gemif papers
%
...
\newcommand{\fracd}[2]{\ensuremath{\frac{\delta   #1}{\delta   #2}}}
\newcommand{\fracp}[2]{\ensuremath{\frac{\partial #1}{\partial #2}}}
