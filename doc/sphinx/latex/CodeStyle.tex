...
\begin{itemize}
    ...
    \item Macros are \verb|UPPER_CASE|
    ...
    \item (*) File names are prefixed with \verb|GEMPIC| and then in snake case, \emph{e.g.} \verb|GEMPIC_some_module.H|
\end{itemize}
...
To help enforce the above conventions we use two clang extra tools: \verb|clang-format| and \verb|clang-format|.
