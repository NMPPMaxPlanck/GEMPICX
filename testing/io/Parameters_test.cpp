...
TEST_F(ParametersTest, InitMainInstanceAndGetSet)
{
    ...
    params.get_or_set("n_cell_vector", something);
...
TEST_F(ParametersTest, ClassFunctionality)
{
    ...
    // Actual tests, reading, writing, etc.
    {
        ...
        params.get_or_set("doesnt_exist", something);
...
TEST(ParametersDeathTests, AttemptedChange)
{
    ...
    Parameters params{};
    params.get_or_set("n_ghost_extra", ghostCellBuffer);
    ...
    EXPECT_EXIT(params.set("n_ghost_extra", ghostCellBuffer),
                ...
                "Error: Parameters class attempted to set parameter n_ghost_extra already set by "
                "Parameters class");
}
