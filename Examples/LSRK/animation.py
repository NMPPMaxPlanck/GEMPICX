# %% [markdown]
# - Convert to jupyter notebook with `jupytext --to ipynb animation.py`
# - back to python percent format with `jupytext --to py:percent --opt notebook_metadata_filter=-all animation.ipynb`
