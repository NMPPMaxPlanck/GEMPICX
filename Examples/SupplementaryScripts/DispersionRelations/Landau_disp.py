# %% [markdown]
# - Convert to jupyter notebook with `jupytext --to ipynb Landau_disp.py`
# - back to python percent format with `jupytext --to py:percent --opt notebook_metadata_filter=-all Landau_disp.ipynb`
