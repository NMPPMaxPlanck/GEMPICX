# %% [markdown]
# - Convert to jupyter notebook with `jupytext --to ipynb LandauIAW.py`
# - back to python percent format with `jupytext --to py:percent --opt notebook_metadata_filter=-all LandauIAW.ipynb`
