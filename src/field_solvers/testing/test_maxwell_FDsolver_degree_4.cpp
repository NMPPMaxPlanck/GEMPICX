...
int main (int argc, char *argv[])
{
    amrex::Initialize(argc, argv);
    {
        ...
        amrex::PrintToFile("test_maxwell_FDsolver_degree_4.output")
            << GEMPIC_SPACEDIM << "D Maxwell degree 4 convergence test:" << std::endl;
        amrex::PrintToFile("test_maxwell_FDsolver_degree_4.output") << std::endl;
        amrex::PrintToFile("test_maxwell_FDsolver_degree_4.output").SetPrecision(3)
        ...
        {
            std::rename("test_maxwell_FDsolver_degree_4.output.0",
                        "test_maxwell_FDsolver_degree_4.output");
        }
    }
    amrex::Finalize();
}
