...
void main_main ()
{
    ...
    //------------------------------------------------------------------------------
    // timeloop
    time_loop_hs_zigzag_C2<vdim, numspec, degx, degy, degz, degmw, true, false, false>(infra, &mw_yee, &part_gr, &diagn, ctest, "test_vlasov_maxwell_hs_zigzag_C2", strang_order);
