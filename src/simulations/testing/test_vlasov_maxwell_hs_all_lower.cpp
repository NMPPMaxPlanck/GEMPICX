...
int main(int argc, char* argv[])
{
    ...
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "0 3.11474e-05 2.66688e-05 0 0 0 5e-07 0.0629525 0.285611 0.990676 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "1 3.11208e-05 2.66766e-05 2.6637e-13 1.22521e-16 8.49692e-16 4.9971e-07 0.0629527 0.285628 0.990641 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "2 3.10768e-05 2.66765e-05 1.04982e-12 1.94511e-15 1.34181e-14 4.99157e-07 0.0629533 0.285656 0.990604 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "3 3.10147e-05 2.66612e-05 2.3054e-12 9.72187e-15 6.64634e-14 4.99244e-07 0.0629543 0.285697 0.990567 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "4 3.0934e-05 2.66326e-05 3.96341e-12 3.01873e-14 2.03742e-13 5.01357e-07 0.0629556 0.285749 0.990529 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "5 3.08359e-05 2.65986e-05 5.936e-12 7.20631e-14 4.78283e-13 5.07176e-07 0.0629572 0.285813 0.990492 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "6 3.07198e-05 2.65483e-05 8.12565e-12 1.4544e-13 9.45374e-13 5.18443e-07 0.0629591 0.285887 0.990458 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "7 3.05846e-05 2.64855e-05 1.04338e-11 2.61095e-13 1.6551e-12 5.3672e-07 0.0629614 0.285972 0.990427 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "8 3.04298e-05 2.64068e-05 1.27694e-11 4.29798e-13 2.6453e-12 5.6315e-07 0.062964 0.286068 0.990398 0.981747" << std::endl;
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "9 3.0256e-05 2.63047e-05 1.50563e-11 6.61687e-13 3.93582e-12 5.98254e-07 0.062967 0.286177 0.990371 0.981747" << std::endl;
    ...
    PrintToFile("test_vlasov_maxwell_hs_all_lower.tmp") << "0 0.594233 0 5e-07 0.00623372 0.0609654 0.185672" << std::endl;
    ...
    if (ParallelDescriptor::MyProc()==0) std::rename("test_vlasov_maxwell_hs_all_lower.output.0", "test_vlasov_maxwell_hs_all_lower.output");
