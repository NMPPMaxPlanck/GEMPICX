...
int main (int argc, char *argv[])
{
...

    {
        ...
        {
            electrons[spec] = std::make_unique<ParticleGroups<vdim>>(spec, infra);
            init_particles_full_domain<vdim, numspec>(infra, electrons, spec);
        }
        ...
        {                         // "Time Loop" scope. Should be a separate function
            ...
            int saveFields = 0;
            params.get_or_set("save_fields", saveFields);
