...
void main_main ()
{
    ...
    VlMa.set_params("test_vlasov_maxwell_hs", {12,8,8});
    VlMa.propagator = 1;
    ...
    loop_preparation<vdim, numspec, degx, degy, degz, degmw, true>(VlMa, infra, &mw_yee, &part_gr, &diagn, VlMa.time_staggered,
                                                                   zero, zero, zero);
