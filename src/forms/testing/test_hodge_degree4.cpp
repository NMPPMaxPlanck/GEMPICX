...
int main (int argc, char *argv[]) 
{
    ...
    {
        amrex::PrintToFile("test_hodge_degree4.output") << std::endl;
        amrex::PrintToFile("test_hodge_degree4.output") << true << std::endl;
    }
    else
    {
        amrex::PrintToFile("test_hodge_degree4.output") << std::endl;
        amrex::PrintToFile("test_hodge_degree4.output") << false << std::endl;
    }
    */

    if (amrex::ParallelDescriptor::MyProc() == 0)
        std::rename("test_hodge_degree4.output.0", "test_hodge_degree4.output");
