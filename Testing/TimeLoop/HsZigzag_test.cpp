...
public:
    ...
    AMREX_GPU_HOST_DEVICE amrex::GpuArray<amrex::Real, vDim> evalSplineField (
...
protected:
    ...
    const int Nghost{Gempic::Test::Utils::initNGhost(degX, degY, degZ)};
    Parameters params;
    ...
    static void SetUpTestSuite ()
    {
        ...
        amrex::ParmParse pp;
        pp.addarr("ComputationalDomain.domainLo", domain_lo);
        pp.addarr("k", k);
    ...
    void SetUp () override
    {
        ...
        {
            particleGroup[spec] = std::make_unique<particle_groups<vDim>>(spec, infra);
        }
    }
};
} // namespace
