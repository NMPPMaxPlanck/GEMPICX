...
protected:
    ...
    Gempic::CompDom::ComputationalDomain m_infra{false};  // "uninitialized" computational domain
    ...
    void SetUp () override { m_infra = Gempic::CompDom::ComputationalDomain{}; }
};
...
TEST_F(FDDeRhamComplexTest, MatrixMultTestDeg2)
{
    ...
    EXPECT_NEAR(1, Gempic::Utils::gempic_norm(rho.m_data, m_infra, 2), 1e-12);
...
TEST_F(FDDeRhamComplexTest, HodgeFDThreeFormZeroFormTest)
{
    ...
    ASSERT_EQ(0, Gempic::Utils::gempic_norm(rho.m_data, m_infra, 2));
