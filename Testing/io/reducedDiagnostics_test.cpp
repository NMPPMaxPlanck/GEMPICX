...
protected:
    ...
    static void SetUpTestSuite ()
    {
        ...
        ppRedDiag.addarr("group_names", reducedDiagsNames);
        ppRedDiag.add("save_interval", saveReduced);
...
TEST_F(ReducedDiagnosticsTest, reducedDiags)
{
    ...
    MultiReducedDiagnostics<s_vdim, s_numspec, s_degX, s_degY, s_degZ, hodgeDegree, 1> redDiagn(
        deRham);
